            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  Any single <code className="highlighter-rouge">.btn</code> can
                  be turned into a dropdown toggle with some markup changes.
            ...
            <Card>
              <CardBody>
                ...
                <p className="card-title-desc">
                  ...
                  to a <code className="highlighter-rouge">.dropdown-menu</code>{" "}
                ...
                >
                  ...
                  >
                    Menu is end-aligned <i className="mdi mdi-chevron-down" />
                  </DropdownToggle>
              ...
              <CardBody>
                ...
                <div className="">
                  <Dropdown
                    ...
                    className="btn-group mt-2 me-1 dropend"
                  >
